...
class Logger(object):
    def __init__(self):
        ...
        self.log = open("BatchSyncLogfile.log", "a")
...
with g.as_default():
    ...
    for i in range(0, 5):
	    ...
	    batch_size = 10 ;
	    _, serialized_example = reader.read_up_to(getfileq(i),batch_size)
	    ...
	    for i in range(0,batch_size):
	    	...
	    	local_gradient = tf.mul(k,exp_v)
            	gradient.append([tf.mul(local_gradient,0.01),index_split[i].values])
