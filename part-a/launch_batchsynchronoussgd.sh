...
#python /home/ubuntu/grader/part-a/synchronoussgd.py >> sync_final_output.txt
#nohup python /home/ubuntu/grader/part-a/synchronoussgd.py > test_console_logging.out 2>&1&
python /home/ubuntu/grader/part-a/batchsynchronoussgd.py 
